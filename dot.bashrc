...
PROMPT_COMMAND='history -a;_kube_ps1_prompt_update;VPS1=$(virtualenv_ps1; printf x);KPS1=$(kube_ps1; printf x);__git_ps1 "$(__gcloud_ps1)${KPS1%x}${VPS1%x}${MY_PS1}" "\\\$ "; set_window_title "$USER@$HOSTNAME:" $(pwd_short)'
